 ...
 *
 * For UNMAPPED results (chemistry channel not in parameter_map):
 *   - The raw chemistry code is stored in parameter_code.
...
class ResultWriter {
   ...
   * @param {string} options.analyzerCode - 'BS230'.
  ...
  constructor(options = {}) {
    ...
    this._analyzerCode = options.analyzerCode || 'BS230';
