...
const REQUIRED_CONNECTION = ['port'];
...
class ConfigLoader {
  ...
  static _loadAnalyserConfig(filePath) {
    ...
    logger.info('Analyser config loaded', {
      analyser: cfg.model,
      site    : cfg.site,
      host    : cfg.connection.host || '0.0.0.0',
